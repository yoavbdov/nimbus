...
export function EventFormModal({
  ...
  return (
    <AddEventModal
      ...
      availablePlayers={addEvent.pickerPlayers}
      ...
      sourceChoiceOpen={addEvent.sourceChoiceOpen}
      onSourceChoiceOpenChange={addEvent.setSourceChoiceOpen}
      rosterChoiceOpen={addEvent.rosterChoiceOpen}
      onRosterChoiceOpenChange={addEvent.setRosterChoiceOpen}
      playerRosters={addEvent.playerRosters}
      onChoosePlayersFromAll={addEvent.choosePlayersFromAll}
      onChoosePlayersFromRoster={addEvent.choosePlayersFromRoster}
      ...
      equipmentShortages={addEvent.equipmentShortages}
      equipmentAvailability={addEvent.equipmentAvailability}
