...
import { leagueActions, type LeagueAction } from "@/lib/league-actions";
import { cn } from "@/lib/utils";

interface LeagueActionsMenuContentProps {
  onSelect: (action: LeagueAction) => void;
}

export function LeagueActionsMenuContent({
  onSelect,
}: LeagueActionsMenuContentProps) {
  const regular = leagueActions.filter((a) => a.variant === "default");
  const destructive = leagueActions.filter((a) => a.variant === "destructive");
