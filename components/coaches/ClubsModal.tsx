      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {editing && (
          <Button
            ...
            aria-label={`הסר שיוך ל${club.name}`}
...
function AddClubField({
  ...
  return (
    <div className="space-y-1.5">
      <Label className="text-foreground/80">שיוך לחוג קיים</Label>
...
export function ClubsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>שיוך לחוגים</DialogTitle>
          <DialogDescription>
            {editing ? "ניהול " : "להלן "}
            החוגים שאליהם משויך{" "}
