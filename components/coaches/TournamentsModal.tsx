      ...
      <div className="flex items-center justify-between gap-3">
        ...
        {editing && (
          <Button
            ...
            aria-label={`הסר שיוך ל${tournament.name}`}
...
function AddTournamentField({
  ...
  return (
    <div className="space-y-1.5">
      <Label className="text-foreground/80">שיוך לתחרות קיימת</Label>
...
export function TournamentsModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>שיוך לתחרות</DialogTitle>
          <DialogDescription>
            {editing ? "ניהול " : "להלן "}
            התחרויות שאליהן משויך{" "}
