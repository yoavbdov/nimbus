...
import { FilterBuilder } from "@/components/tournaments/filters/FilterBuilder";
...
interface FilterChipProps {
  ...
  onUpdate: (filter: TournamentFilter) => void;
  onRemove: () => void;
}
...
export function FilterChip({ filter, onUpdate, onRemove }: FilterChipProps) {
  ...
  function handleSubmit(next: TournamentFilter) {
    onUpdate(next);
    close();
  }
